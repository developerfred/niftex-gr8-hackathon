...
contract NiftexTokenFactory {function NiftexToken(string calldata _name, string calldata _symbol, uint8 _decimals, address _owner, uint256 _totalSupply, uint256 _totalSupplyCap, bool _transferable) external {new NiftexToken(_name, _symbol, _decimals, _owner, _totalSupply, _totalSupplyCap, _transferable);}}
